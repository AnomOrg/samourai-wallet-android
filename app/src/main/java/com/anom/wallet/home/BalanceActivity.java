...
import com.anom.wallet.JSONRPC.JSONRPC;
import com.anom.wallet.JSONRPC.PoW;
import com.anom.wallet.JSONRPC.TrustedNodeUtil;
import com.anom.wallet.R;
import com.anom.wallet.access.AccessFactory;
import com.anom.wallet.bip47.BIP47Meta;
import com.anom.wallet.bip47.BIP47Util;
import com.anom.wallet.bip47.paynym.WebUtil;
import com.anom.wallet.cahoots.Cahoots;
import com.anom.wallet.cahoots.CahootsUtil;
import com.anom.wallet.network.NetworkDashboard;
import com.anom.wallet.network.dojo.DojoUtil;
import com.anom.wallet.payload.PayloadUtil;
import com.anom.wallet.paynym.ClaimPayNymActivity;
import com.anom.wallet.paynym.PayNymHome;
import com.anom.wallet.segwit.bech32.Bech32Util;
import com.anom.wallet.send.BlockedUTXO;
import com.anom.wallet.send.MyTransactionOutPoint;
import com.anom.wallet.send.SendActivity;
import com.anom.wallet.send.SweepUtil;
import com.anom.wallet.send.UTXO;
import com.anom.wallet.service.RefreshService;
import com.anom.wallet.service.WebSocketService;
import com.anom.wallet.tor.TorManager;
import com.anom.wallet.tor.TorService;
import com.anom.wallet.util.AppUtil;
import com.anom.wallet.util.FormatsUtil;
import com.anom.wallet.util.MessageSignUtil;
import com.anom.wallet.util.MonetaryUtil;
import com.anom.wallet.util.PrefsUtil;
import com.anom.wallet.util.PrivKeyReader;
import com.anom.wallet.util.TimeOutUtil;
import com.anom.wallet.widgets.ItemDividerDecorator;
import com.dm.zbar.android.scanner.ZBarConstants;
import com.anom.wallet.ExodusActivity;
;
import com.anom.wallet.ReceiveActivity;
import com.anom.wallet.SamouraiWallet;
import com.anom.wallet.SettingsActivity;
import com.anom.wallet.UTXOActivity;
import com.anom.wallet.api.APIFactory;
import com.anom.wallet.api.Tx;
import com.anom.wallet.fragments.CameraFragmentBottomSheet;
import com.samourai.wallet.crypto.AESUtil;
import com.samourai.wallet.crypto.DecryptionException;
import com.samourai.wallet.hd.HD_Wallet;
import com.anom.wallet.hd.HD_WalletFactory;
import com.anom.wallet.whirlpool.WhirlpoolMeta;
import com.anom.wallet.home.adapters.TxAdapter;
import com.anom.wallet.permissions.PermissionsUtil;
import com.anom.wallet.ricochet.RicochetMeta;
import com.anom.wallet.tx.TxDetailsActivity;
...
//        LocalBroadcastManager.getInstance(BalanceActivity.this).registerReceiver(receiver, filter);
        ...
        Intent intent = new Intent("MainActivity2.RESTART_SERVICE");
        ...
        try {
            ...
            for (String code : paymentCodes) {
                Picasso.with(getBaseContext())
                        .load(WebUtil.PAYNYM_API + code + "/avatar").fetch(new Callback() {
                    @Override
...
//                    Log.d("BalanceActivity", obj.toString());
            String res = WebUtil.getInstance(BalanceActivity.this).postURL("application/json", null, WebUtil.PAYNYM_API + "api/v1/token", obj.toString());
...
//                        Log.d("BalanceActivity", "nym/add:" + obj.toString());
                res = WebUtil.getInstance(BalanceActivity.this).postURL("application/json", token, WebUtil.PAYNYM_API + "api/v1/nym/add", obj.toString());
//                        Log.d("BalanceActivity", res);
