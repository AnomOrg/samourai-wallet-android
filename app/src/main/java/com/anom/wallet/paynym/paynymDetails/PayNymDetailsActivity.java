package com.anom.wallet.paynym.paynymDetails;
...
import com.anom.wallet.bip47.SendNotifTxFactory;
import com.samourai.wallet.bip47.rpc.PaymentAddress;
import com.samourai.wallet.bip47.rpc.PaymentCode;
import com.anom.wallet.bip47.rpc.SecretPoint;
import com.samourai.wallet.crypto.DecryptionException;
import com.anom.wallet.hd.HD_WalletFactory;
import com.anom.wallet.paynym.fragments.EditPaynymBottomSheet;
import com.anom.wallet.paynym.fragments.ShowPayNymQRBottomSheet;
import com.anom.wallet.segwit.BIP49Util;
import com.anom.wallet.segwit.BIP84Util;
import com.anom.wallet.segwit.bech32.Bech32Util;
import com.anom.wallet.send.FeeUtil;
import com.anom.wallet.send.MyTransactionInput;
import com.anom.wallet.send.MyTransactionOutPoint;
import com.anom.wallet.send.PushTx;
import com.anom.wallet.send.SendFactory;
import com.anom.wallet.send.SuggestedFee;
import com.anom.wallet.send.UTXO;
import com.anom.wallet.send.UTXOFactory;
import com.anom.wallet.util.AddressFactory;
...
import com.anom.wallet.util.SentToFromBIP47Util;
...
//                        Log.i("SendNotifTxFactory", "tx hash:" + tx.getHashAsString());
    ...
    private void doUpdatePayNymInfo(final String pcode) {
        ...
        Disposable disposable = Observable.fromCallable(() -> {
            ...
            obj.put("nym", pcode);
            String res = WebUtil.getInstance(this).postURL("application/json", null, WebUtil.PAYNYM_API + "api/v1/nym", obj.toString());
...
//                    Log.d("PayNymDetailsActivity", obj.toString());
                String res = WebUtil.getInstance(this).postURL("application/json", null, WebUtil.PAYNYM_API + "api/v1/token", obj.toString());
//                    Log.d("PayNymDetailsActivity", res);
