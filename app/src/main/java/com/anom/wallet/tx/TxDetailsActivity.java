...
import com.anom.wallet.send.boost.CPFPTask;
import com.anom.wallet.send.boost.RBFTask;
import com.anom.wallet.util.DateUtil;
import com.anom.wallet.widgets.CircleImageView;
...
public class TxDetailsActivity extends AppCompatActivity {
    ...
    private void showPaynym() {
        ...
        Picasso.with(this)
                .load(WebUtil.PAYNYM_API + tx.getPaymentCode() + "/avatar")
                .into(payNymAvatar);
