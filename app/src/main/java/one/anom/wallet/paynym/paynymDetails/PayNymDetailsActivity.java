package one.anom.wallet.paynym.paynymDetails;
...
//        Log.i(TAG, "setPayNym: ".concat(String.valueOf(BIP47Meta.getInstance().getOutgoingStatus(pcode))));
        ...
        Picasso.with(getApplicationContext())
                .load(one.anom.wallet.bip47.paynym.WebUtil.PAYNYM_API + pcode + "/avatar")
...
//                        Log.i("SendNotifTxFactory", "tx hash:" + tx.getHashAsString());
    ...
    private void doUpdatePayNymInfo(final String pcode) {
        ...
        Disposable disposable = Observable.fromCallable(() -> {
            ...
            obj.put("nym", pcode);
            String res = one.anom.wallet.bip47.paynym.WebUtil.getInstance(this).postURL("application/json", null, one.anom.wallet.bip47.paynym.WebUtil.PAYNYM_API + "api/v1/nym", obj.toString());
...
//                    Log.d("PayNymDetailsActivity", obj.toString());
                String res = one.anom.wallet.bip47.paynym.WebUtil.getInstance(this).postURL("application/json", null, one.anom.wallet.bip47.paynym.WebUtil.PAYNYM_API + "api/v1/token", obj.toString());
//                    Log.d("PayNymDetailsActivity", res);
...
//                        Log.d("PayNymDetailsActivity", "follow:" + obj.toString());
                    ...
                    res = one.anom.wallet.bip47.paynym.WebUtil.getInstance(this).postURL("application/json", token, one.anom.wallet.bip47.paynym.WebUtil.PAYNYM_API + endPoint, obj.toString());
//                        Log.d("PayNymDetailsActivity", res);
