...
//            throw new RuntimeException(e);
    ...
    protected void signTx(HashMap<String,ECKey> keyBag) {
        ...
        LogUtil.debug("Cahoots", "signTx:" + transaction.toString());
