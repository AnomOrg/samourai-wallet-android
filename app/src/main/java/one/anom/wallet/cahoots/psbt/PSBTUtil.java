        ...
        AlertDialog.Builder dlg = new AlertDialog.Builder(context)
                ...
                .setNegativeButton(R.string.psbt_sign_tx, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        LogUtil.debug("PSBTUtil", "  signed tx hash:" + tx.getHashAsString());
    ...
    public Transaction doPSBTSignTx(PSBT psbt)    {
        ...
        for(PSBTEntry entry : psbtInputs) {
            ...
            if(entry.getKeyType() == null) {
                ...
                value = pair.getLeft();
                LogUtil.debug("PSBTUtil", "value:" + value);
            }
                ...
                LogUtil.debug("PSBTUtil", "path:" + path);
                ...
                LogUtil.debug("PSBTUtil", "address:" + address.getBech32AsString());
                eckeyPriv = address.getECKey();
                LogUtil.debug("PSBTUtil", "hasPrivKey:" + eckeyPriv.hasPrivKey());
            }
    ...
    public Transaction signTx(Transaction transaction, HashMap<String,ECKey> keyBag, HashMap<String,Long> amountBag) {
        ...
        for(int i = 0; i < transaction.getInputs().size(); i++)   {
            ...
            if(keyBag.containsKey(outpoint.toString())) {
                ...
                LogUtil.debug("PSBTUtil", "signTx outpoint:" + outpoint.toString());
                ...
                LogUtil.debug("PSBTUtil", "signTx bech32:" + segwitAddress.getBech32AsString());

                final Script redeemScript = segwitAddress.segWitRedeemScript();
                LogUtil.debug("PSBTUtil", "signTx bech32:" + Hex.toHexString(redeemScript.getProgram()));
                final Script scriptCode = redeemScript.scriptCode();

                long value = amountBag.get(outpoint.toString());
                LogUtil.debug("PSBTUtil", "signTx value:" + value);
